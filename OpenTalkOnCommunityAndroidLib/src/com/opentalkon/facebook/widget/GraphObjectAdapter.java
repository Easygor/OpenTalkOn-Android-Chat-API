...
import com.opentalkon.facebook.internal.ImageDownloader;
import com.opentalkon.facebook.internal.ImageRequest;
import com.opentalkon.facebook.internal.ImageResponse;
import com.opentalkon.facebook.model.GraphObject;
...
class GraphObjectAdapter<T extends GraphObject> extends BaseAdapter implements SectionIndexer {
    ...
    protected View getSectionHeaderView(String sectionHeader, View convertView, ViewGroup parent) {
        ...
        if (result == null) {
            result = (TextView) inflater.inflate(R.layout.com_opentalkon_facebook_picker_list_section_header, null);
        }
    ...
    private View getActivityCircleView(View convertView, ViewGroup parent) {
        ...
        if (result == null) {
            result = inflater.inflate(R.layout.com_opentalkon_facebook_picker_activity_circle_row, null);
        }
        ProgressBar activityCircle = (ProgressBar) result.findViewById(R.id.com_opentalkon_facebook_picker_row_activity_circle);
    ...
    protected int getGraphObjectRowLayoutId(T graphObject) {
        return R.layout.com_opentalkon_facebook_picker_list_row;
    }

    protected int getDefaultPicture() {
        return R.drawable.com_opentalkon_facebook_profile_default_icon;
    }

    protected View createGraphObjectView(T graphObject) {
        View result = inflater.inflate(getGraphObjectRowLayoutId(graphObject), null);

        ViewStub checkboxStub = (ViewStub) result.findViewById(R.id.com_opentalkon_facebook_picker_checkbox_stub);
        ...
        ViewStub profilePicStub = (ViewStub) result.findViewById(R.id.com_opentalkon_facebook_picker_profile_pic_stub);
        if (!getShowPicture()) {
    ...
    protected void populateGraphObjectView(View view, T graphObject) {
        ...
        TextView titleView = (TextView) view.findViewById(R.id.com_opentalkon_facebook_picker_title);
        if (titleView != null) {
        ...
        if (getShowCheckbox()) {
            CheckBox checkBox = (CheckBox) view.findViewById(R.id.com_opentalkon_facebook_picker_checkbox);
        ...
        if (getShowPicture()) {
            ...
            if (pictureURI != null) {
                ImageView profilePic = (ImageView) view.findViewById(R.id.com_opentalkon_facebook_picker_image);
    ...
    String getPictureFieldSpecifier() {
        ...
        ImageView picture = (ImageView) view.findViewById(R.id.com_opentalkon_facebook_picker_image);
        if (picture == null) {
            return null;
        }
