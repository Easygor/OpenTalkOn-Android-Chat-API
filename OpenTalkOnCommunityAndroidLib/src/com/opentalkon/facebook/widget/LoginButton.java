...
package com.opentalkon.facebook.widget;
...
import com.opentalkon.facebook.AppEventsLogger;
import com.opentalkon.facebook.FacebookException;
import com.opentalkon.facebook.Request;
import com.opentalkon.facebook.Response;
import com.opentalkon.facebook.Session;
import com.opentalkon.facebook.SessionDefaultAudience;
import com.opentalkon.facebook.SessionLoginBehavior;
import com.opentalkon.facebook.SessionState;
import com.opentalkon.facebook.internal.AnalyticsEvents;
import com.opentalkon.facebook.internal.SessionAuthorizationType;
import com.opentalkon.facebook.internal.SessionTracker;
import com.opentalkon.facebook.internal.Utility;
 ...
 * (i.e. if the session is in the {@link com.opentalkon.facebook.SessionState#CREATED_TOKEN_LOADED} state.
 * Developers can override the use of the active session by calling
 * the {@link #setSession(com.opentalkon.facebook.Session)} method.
 */
public class LoginButton extends Button {
    ...
    public LoginButton(Context context, AttributeSet attrs) {
        ...
        if (attrs.getStyleAttribute() == 0) {
            ...
            this.setTextColor(getResources().getColor(R.color.com_opentalkon_facebook_loginview_text_color));
            this.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                    getResources().getDimension(R.dimen.com_opentalkon_facebook_loginview_text_size));
            this.setTypeface(Typeface.DEFAULT_BOLD);
            if (isInEditMode()) {
                // cannot use a drawable in edit mode, so setting the background color instead
                // of a background resource.
                this.setBackgroundColor(getResources().getColor(R.color.com_opentalkon_facebook_blue));
                // hardcoding in edit mode as getResources().getString() doesn't seem to work in IntelliJ
                loginText = "Log in with Facebook";
            } else {
                this.setBackgroundResource(R.drawable.com_opentalkon_facebook_button_blue);
                this.setCompoundDrawablesWithIntrinsicBounds(R.drawable.com_opentalkon_facebook_inverse_icon, 0, 0, 0);
                this.setCompoundDrawablePadding(
                        getResources().getDimensionPixelSize(R.dimen.com_opentalkon_facebook_loginview_compound_drawable_padding));
                this.setPadding(getResources().getDimensionPixelSize(R.dimen.com_opentalkon_facebook_loginview_padding_left),
                        getResources().getDimensionPixelSize(R.dimen.com_opentalkon_facebook_loginview_padding_top),
                        getResources().getDimensionPixelSize(R.dimen.com_opentalkon_facebook_loginview_padding_right),
                        getResources().getDimensionPixelSize(R.dimen.com_opentalkon_facebook_loginview_padding_bottom));
            }
        }
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.com_opentalkon_facebook_login_view);
        confirmLogout = a.getBoolean(R.styleable.com_opentalkon_facebook_login_view_com_opentalkon_confirm_logout, true);
        fetchUserInfo = a.getBoolean(R.styleable.com_opentalkon_facebook_login_view_com_opentalkon_fetch_user_info, true);
        loginText = a.getString(R.styleable.com_opentalkon_facebook_login_view_com_opentalkon_login_text);
        logoutText = a.getString(R.styleable.com_opentalkon_facebook_login_view_com_opentalkon_logout_text);
        a.recycle();
    }
    ...
    private void setButtonText() {
        if (sessionTracker != null && sessionTracker.getOpenSession() != null) {
            setText((logoutText != null) ? logoutText :
                    getResources().getString(R.string.com_opentalkon_facebook_loginview_log_out_button));
        } else {
            setText((loginText != null) ? loginText :
                    getResources().getString(R.string.com_opentalkon_facebook_loginview_log_in_button));
        }
    }
        ...
        public void onClick(View v) {
            ...
            if (openSession != null) {
                ...
                if (confirmLogout) {
                    ...
                    String logout = getResources().getString(R.string.com_opentalkon_facebook_loginview_log_out_action);
                    String cancel = getResources().getString(R.string.com_opentalkon_facebook_loginview_cancel_action);
                    String message;
                    if (user != null && user.getName() != null) {
                        message = String.format(getResources().getString(R.string.com_opentalkon_facebook_loginview_logged_in_as), user.getName());
                    } else {
                        message = getResources().getString(R.string.com_opentalkon_facebook_loginview_logged_in_using_facebook);
                    }
