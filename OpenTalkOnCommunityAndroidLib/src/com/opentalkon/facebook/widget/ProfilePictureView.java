...
import com.opentalkon.facebook.LoggingBehavior;
...
import com.opentalkon.facebook.internal.Logger;
...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.com_opentalkon_facebook_profile_picture_view);
        setPresetSize(a.getInt(R.styleable.com_opentalkon_facebook_profile_picture_view_com_opentalkon_preset_size, CUSTOM));
        isCropped = a.getBoolean(R.styleable.com_opentalkon_facebook_profile_picture_view_com_opentalkon_is_cropped, IS_CROPPED_DEFAULT_VALUE);
        a.recycle();
    }
    ...
    private void setBlankProfilePicture() {
        if (customizedDefaultProfilePicture == null) {
          int blankImageResource = isCropped() ?
                  R.drawable.com_opentalkon_facebook_profile_picture_blank_square :
                  R.drawable.com_opentalkon_facebook_profile_picture_blank_portrait;
    ...
    private int getPresetSizeInPixels(boolean forcePreset) {
        ...
        switch (presetSizeType) {
            case SMALL:
                dimensionId = R.dimen.com_opentalkon_facebook_profilepictureview_preset_size_small;
                break;
            case NORMAL:
                dimensionId = R.dimen.com_opentalkon_facebook_profilepictureview_preset_size_normal;
                break;
            case LARGE:
                dimensionId = R.dimen.com_opentalkon_facebook_profilepictureview_preset_size_large;
                break;
            case CUSTOM:
                if (!forcePreset) {
