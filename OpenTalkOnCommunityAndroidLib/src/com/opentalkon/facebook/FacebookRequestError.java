    ...
    private FacebookRequestError(int requestStatusCode, int errorCode,
        ...
        if (isLocalException) {
            ...
            if (errorCode == EC_UNKNOWN_ERROR || errorCode == EC_SERVICE_UNAVAILABLE) {
                ...
                messageId = R.string.com_opentalkon_facebook_requesterror_permissions;
                ...
                if (subErrorCode == EC_USER_CHECKPOINTED || subErrorCode == EC_UNCONFIRMED_USER) {
                    ...
                    messageId = R.string.com_opentalkon_facebook_requesterror_web_login;
                    shouldNotify = true;
                } else {
                    errorCategory = Category.AUTHENTICATION_REOPEN_SESSION;

                    if ((subErrorCode == EC_APP_NOT_INSTALLED) || (subErrorCode == EC_EXPIRED)) {
                        messageId = R.string.com_opentalkon_facebook_requesterror_relogin;
                    } else if (subErrorCode == EC_PASSWORD_CHANGED) {
                        messageId = R.string.com_opentalkon_facebook_requesterror_password_changed;
                    } else {
                        messageId = R.string.com_opentalkon_facebook_requesterror_reconnect;
                        shouldNotify = true;
                    }
                }
            }
