...
import com.opentalkon.facebook.internal.NativeProtocol;
import com.opentalkon.facebook.internal.ServerProtocol;
import com.opentalkon.facebook.internal.Utility;
import com.opentalkon.facebook.model.GraphMultiResult;
import com.opentalkon.facebook.model.GraphObject;
import com.opentalkon.facebook.model.GraphObjectList;
import com.opentalkon.facebook.model.GraphUser;
import com.opentalkon.facebook.widget.WebDialog;
...
class AuthorizationClient implements Serializable {
    ...
    boolean checkInternetPermission() {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            String errorType = context.getString(R.string.com_opentalkon_facebook_internet_permission_error_title);
            String errorDescription = context.getString(R.string.com_opentalkon_facebook_internet_permission_error_message);
