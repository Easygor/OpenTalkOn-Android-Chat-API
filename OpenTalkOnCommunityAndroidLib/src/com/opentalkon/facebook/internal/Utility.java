...
package com.opentalkon.facebook.internal;
...
import com.thinkspace.opentalkon.BuildConfig;
...
public final class Utility {
    ...
    private static String metaApplicationId;
	public static void setMetaApplicationId(String metaApplicationId) {
		Utility.metaApplicationId = metaApplicationId;
	}

    public static String getMetadataApplicationId(Context context) {
        Validate.notNull(context, "context");

        if(metaApplicationId != null){
