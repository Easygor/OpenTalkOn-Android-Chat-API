...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.com_opentalkon_facebook_login_activity_layout);
        ...
        authorizationClient.setBackgroundProcessingListener(new AuthorizationClient.BackgroundProcessingListener() {
            ...
            public void onBackgroundProcessingStarted() {
                findViewById(R.id.com_opentalkon_facebook_login_activity_progress_bar).setVisibility(View.VISIBLE);
            }

            @Override
            public void onBackgroundProcessingStopped() {
                findViewById(R.id.com_opentalkon_facebook_login_activity_progress_bar).setVisibility(View.GONE);
            }
        });
    }
