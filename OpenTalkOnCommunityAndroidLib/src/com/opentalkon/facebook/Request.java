...
import com.opentalkon.facebook.model.*;
...
public class Request {
     ...
     * {@link Request#executeMeRequestAsync(Session, com.opentalkon.facebook.Request.GraphUserCallback)}
    ...
    /**
     * Specifies the interface that consumers of
     * {@link Request#executeMyFriendsRequestAsync(Session, com.opentalkon.facebook.Request.GraphUserListCallback)}
     * can use to be notified when the request completes, either successfully or with an error.
     */
    ...
    /**
     * Specifies the interface that consumers of
     * {@link Request#executePlacesSearchRequestAsync(Session, android.location.Location, int, int, String, com.opentalkon.facebook.Request.GraphPlaceListCallback)}
     * can use to be notified when the request completes, either successfully or with an error.
     */
