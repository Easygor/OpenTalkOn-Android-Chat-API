 ...
 * It is not implemented by any concrete classes, but rather by a proxy (see the {@link com.opentalkon.facebook.model.GraphObject.Factory Factory}
...
public interface GraphObjectList<T> extends List<T> {
     ...
     * @throws com.opentalkon.facebook.FacebookGraphObjectException if T does not derive from GraphObject
     */
