...
public class OTOApp {
	...
	public void changeUserDatabase(long prev_user_id, long user_id){
		...
		CommunityLastTimeTable.getInstance();
	}
	
	public void InitializeAuth(boolean showToast){
		pref.getFacebook_id().setValue("");
	...
	public void InitOpenTalkLib(Context context, String appToken, BroadcastReceiver receiver) {
		instance = this;
		...
		setupSateliteHost();
		Utility.setMetaApplicationId(context.getString(R.string.oto_facebook_app_id));
		handler = new Handler();
