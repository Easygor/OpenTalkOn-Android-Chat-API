...
public class OTFriendPopup extends Activity implements TADataHandler{
	...
	public void drawLayout(){
		...
		if(userInfo != null){
			...
			if(userInfo.getFacebook_id() != null){
				...
				facebook.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						...
						try {
							...
							i = new Intent(Intent.ACTION_VIEW, Uri.parse("fb://profile/" + userInfo.getFacebook_id()));
						} catch (Exception e) {
							i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/" + userInfo.getFacebook_id()));
						}
						startActivity(i);
					}
				});
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		facebook = findViewById(R.id.oto_oto_friend_detail_facebook);
		facebook.setVisibility(View.GONE);
