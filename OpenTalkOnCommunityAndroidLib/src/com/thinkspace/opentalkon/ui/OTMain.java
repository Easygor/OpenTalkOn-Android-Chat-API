...
public class OTMain extends PLActivityGroup implements OnClickListener, PLMsgHandler {
	...
	public class PL_TAB_STATE {
		...
		public void settingAll(){
			...
			Pages.add(new PageSet(OTMainTabRecent.class, R.drawable.oto_main_tab_recent_n, R.drawable.oto_main_tab_recent_s,
					getString(R.string.oto_recent_talk)));
			Pages.add(new PageSet(OTMainTabOpenTalk.class, R.drawable.oto_friend_top_menu_01_n, R.drawable.oto_friend_top_menu_01_s,
					getString(R.string.oto_friend_tab_1)));
	...
	public void onMsgReceived(OTMsgBase msg) {
		menuButtons.get(3).setNewCount(OTOApp.getInstance().getCacheCtrl().getAllUnReadMsg());
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(OTOApp.getInstance().getPref().getAgree_term().getValue() == false){
	...
	public void setupMenuButton(){
		...
		menuButtons.add((BaseTabButtonView)findViewById(R.id.oto_base_tab_btn4));
		menuButtons.add((BaseTabButtonView)findViewById(R.id.oto_base_tab_btn5));
