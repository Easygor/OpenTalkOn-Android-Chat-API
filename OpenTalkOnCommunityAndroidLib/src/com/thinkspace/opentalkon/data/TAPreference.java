...
public class TAPreference {
	...
	PrefBooleanMgr setting_opentalk_new_post_notifiy;
	PrefBooleanMgr setting_opentalk_my_like_notifiy;
	PrefBooleanMgr setting_opentalk_my_reply_notifiy;
	PrefBooleanMgr setting_opentalk_reply_notifiy;
	...
	public PrefBooleanMgr getSetting_opentalk_new_post_notifiy() { return setting_opentalk_new_post_notifiy; }
	public PrefBooleanMgr getSetting_opentalk_my_like_notifiy() { return setting_opentalk_my_like_notifiy; }
	public PrefBooleanMgr getSetting_opentalk_my_reply_notifiy() { return setting_opentalk_my_reply_notifiy; }
	public PrefBooleanMgr getSetting_opentalk_reply_notifiy() { return setting_opentalk_reply_notifiy; }
	...
	public PrefStringMgr getFacebook_id() { return facebook_id; }
	...
	public TAPreference(Context context)
	{
		...
		setting_opentalk_new_post_notifiy = new PrefBooleanMgr("setting_opentalk_new_post_notifiy", true, con);
		setting_opentalk_my_like_notifiy = new PrefBooleanMgr("setting_opentalk_my_like_notifiy", true, con);
		setting_opentalk_my_reply_notifiy = new PrefBooleanMgr("setting_opentalk_my_reply_notifiy", true, con);
		setting_opentalk_reply_notifiy = new PrefBooleanMgr("setting_opentalk_reply_notifiy", true, con);
		...
		facebook_id = new PrefStringMgr("facebook_id", "", con);
