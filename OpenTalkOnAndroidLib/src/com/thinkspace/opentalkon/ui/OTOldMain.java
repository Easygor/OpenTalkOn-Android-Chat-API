...
public class OTOldMain extends PLActivityGroup implements OnClickListener, PLMsgHandler {
	...
	public class PL_TAB_STATE {
		...
		public void settingAll(){
			...
			Pages.add(new PageSet(OTMainTabFollowingList.class, R.drawable.oto_friend_top_menu_02_n, R.drawable.oto_friend_top_menu_02_s,
